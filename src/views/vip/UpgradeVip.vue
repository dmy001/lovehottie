...
export default {
  ...
  data() {
    return {
      ...
      descrip2:['无限聊天权限 ','价值30金币的VIP会员优惠券','每月免费查看10张模糊图','每月免费赠送5个虚拟礼物','会员专属标识'],
      
      descriptionList:[
        {name:"每天50条聊天权限",descrip:'每天50条消息权限，给你向世界Say Hi的体验。（若翻译需另收费）'},
        {name:"优惠券",descrip:'赠送一张价值30金币VIP优惠券：购买MiNi会员赠送价值30金币VIP优惠券一张，帮助你节省购买会员的费用。'},
        {name:"模糊图",descrip:'免费查看3张模糊图：会员期间免费查看3张模糊图，给你高清体验。'},
        {name:"会员权限",descrip:'会员专属标识：您的昵称会增加会员专属标识，彰显等级魅力，让ta一眼看到你。'},
        {name:"阅后即焚免费无限使用",descrip:'消息、国际圈等均可免费无限使用阅后即焚功能。'},
      ],
       descriptionList1:[
        {name:"1500/天免费翻译字符",descrip:'开启VIP，在消息中尊享最优质的免费人工翻译服务，无限畅聊，拉近你和ta的距离。'},
        {name:"3个10min翻译vip",descrip:'开启VIP，即可享受3个10min翻译vip权限'},
        {name:"无限免费查看模糊图",descrip:'无限制的查看模糊图片，给你高清体验。'},
        {name:"无限免费赠送虚拟礼物",descrip:'虚拟礼物无限免费赠送，成功引起ta的注意'},
        {name:"消息已读通知",descrip:'还在纠结对方是否已经看到你的信息？成为vip，这些都不是问题。'},
         {name:"无限发消息",descrip:'消息不受限，想发多少随你定。（消息翻译若超过1500字符则另收费）'},
          {name:"主页可无限制展示照片",descrip:'您的主页可无限制展示照片，更加全面的展示自己。'},
           {name:"会员专属标识",descrip:'您的昵称会增加会员专属标识，彰显等级魅力，让ta一眼看到你。'},
            {name:"优先推荐",descrip:'您会被优先推荐给新用户，获得更多的交友机会。'},
             {name:"谁在暗恋你，vip告诉你",descrip:'查看谁给您偷偷点赞，恰好你也对ta感兴趣，就别犹豫。'},
      ],
      descriptionList2:[
        {name:"无限发消息",descrip:'消息不受限，想发多少随你定。（消息翻译若超过1500字符则另收费）'},
        {name:"优惠券",descrip:'赠送一张价值30金币VIP优惠券：购买高级会员赠送价值30金币VIP优惠券一张，帮助你节省购买会员的费用。'},
        {name:"优先推荐",descrip:'您会被优先推荐给新用户，获得更多的交友机会。'},
        {name:"每月免费查看10张模糊图",descrip:'每个月能够查看 10 张聊天中的模糊图片，给你高清体验'},
        {name:"每月免费赠送5个虚拟礼物",descrip:'5个虚拟礼物每月免费赠送，给热聊中的ta一个惊喜'},
        {name:"会员专属标识",descrip:'您的昵称会增加会员专属标识，彰显等级魅力，让ta一眼看到你。'},
        {name:"主页可无限制展示照片",descrip:'您的主页可无限制展示照片，更加全面的展示自己。'},
        {name:"阅后即焚免费无限使用",descrip:'消息、国际圈等均可免费无限使用阅后即焚功能。'},
      ],
